...
7. **Documentation maintenance:** `docs/documentation_maintenance.md` (when to update docs).
...
- **Version Control (AI Agents):** **CRITICAL:** NEVER commit or push changes to version control on the user's behalf. At most, you may suggest a commit message for their uncommitted changes.
